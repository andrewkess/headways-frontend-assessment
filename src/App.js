...
function App() {
  ...
  return (
    <div className='grid min-h-screen place-content-center bg-gray-200 overflow-y-hidden'>
      <div className='w-[95vw] sm:w-[550px] rounded-lg border border-gray-400 bg-white'>
